...
/**
 * Minimal resume + email CTA — lives near the bottom of Professional mode.
 * The bulk of contact info (email card, socials, My Story) has moved into the
 * rebuilt About section; this keeps the download-resume action accessible
 * without duplicating the full contact block.
 */
